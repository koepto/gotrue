...
BEGIN
  IF NOT EXISTS(SELECT *
    ...
    WHERE table_schema = 'auth' and table_name='user' and column_name='email_change_token_new')
  THEN
      ALTER TABLE "auth"."user" RENAME COLUMN "email_change_token" TO "email_change_token_new";
  END IF;
END $$;
